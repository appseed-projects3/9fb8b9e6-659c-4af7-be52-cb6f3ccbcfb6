...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-04 16:30`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9fb8b9e6-659c-4af7-be52-cb6f3ccbcfb6.git
$ cd 9fb8b9e6-659c-4af7-be52-cb6f3ccbcfb6
```
